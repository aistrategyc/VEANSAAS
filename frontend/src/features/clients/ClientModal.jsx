  ...
  const handleSave = () => {
    ...
    const clientData = {
      ...
      preferences: {
        ...
        preferredMasters:
          formData.preferences.preferredMasters.length > 0 ? formData.preferences.preferredMasters : undefined,
                ...
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start bg-transparent">
                    ...
                    {formData.dateOfBirth
                      ? format(new Date(formData.dateOfBirth), "d MMMM yyyy", { locale: ru })
                      : "Выберите дату"}
                  </Button>
                </PopoverTrigger>
