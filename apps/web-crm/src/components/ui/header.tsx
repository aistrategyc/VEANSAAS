    ...
    >
      <nav className="container mx-auto px-4 md:px-6 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          {/* Логотип */}
          <Link href="/dashboard" className="flex items-center space-x-3 select-none group">
          ...
          <div className="hidden lg:flex flex-1 max-w-md">
            <div className="flex items-center w-full bg-white/60 backdrop-blur-sm border border-gray-200/50 px-4 py-2.5 rounded-xl shadow-sm hover:shadow-md focus-within:shadow-md focus-within:border-purple-300 transition-all duration-200">
          ...
          <div className="hidden md:flex items-center gap-2">
            {user ? (
              <>
                <button
                  className="inline-flex items-center justify-center rounded-xl p-2.5 hover:bg-purple-50 hover:text-purple-600 transition-all duration-200"
                  onClick={() => router.push('/calendar')}
                  aria-label="Calendar"
                  title="Calendar"
                >
                  <Calendar size={20} className="text-gray-600 hover:text-purple-600 transition-colors" />
                </button>
                ...
                <button
                  ...
                  title="AI Chat"
                >
                  <MessageSquare size={20} className="text-gray-600 hover:text-purple-600 transition-colors" />
                </button>
                ...
                <div className="relative">
                  <button
                    ...
                    title="Notifications"
                  >
                    <Bell size={20} className="text-gray-600 hover:text-purple-600 transition-colors" />
                  </button>
                  <span className="absolute -top-1 -right-1 bg-gradient-to-r from-purple-500 to-pink-500 text-xs font-bold rounded-full min-w-[20px] h-5 flex items-center justify-center text-white shadow-sm">
                    5
                  </span>
                </div>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      className="ml-3 inline-flex items-center gap-3 rounded-xl px-3 py-2 hover:bg-white/80 hover:shadow-md transition-all duration-200 border border-gray-200/50"
      ...
      <div className="px-4 md:px-6 pb-4 lg:hidden">
        <div className="flex items-center w-full bg-white/60 backdrop-blur-sm border border-gray-200/50 px-4 py-3 rounded-xl shadow-sm hover:shadow-md focus-within:shadow-md focus-within:border-purple-300 transition-all duration-200">
          <Search size={18} className="text-gray-400 mr-3" />
          <input
            type="text"
            placeholder="Поиск клиентов, записей..."
